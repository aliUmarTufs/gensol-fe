...
const CheckoutEducation = ({ formData, handleSubmitForm = () => {} }) => {
  ...
  return (
    <div className="main-wrapper checkoutedu">
      <BlackBox>
        ...
        <Form form={form}>
          <div className="payment-method-main-wrapper">
            ...
            <div className="card-detail-wrapper">
              <p>Address</p>
              <Row gutter={[16, 16]} className="card-detail-wrap-box">
                <Col xs={24}>
                  <Form.Item
                    name="fullName"
                    rules={[
          ...
          <div className="black-box-btn-wrapper">
            <CommonButton text="Pay" width={'172px'} onClick={handleNext} />
          </div>
        </Form>
      </BlackBox>
...
export default CheckoutEducation;
